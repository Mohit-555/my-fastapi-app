...
def receive_fixed_parameters(
    ...
    """
    Receive fixed-interval parameter data (every 5 sec). Supports partial success responses.
    """
...
def receive_event_parameters(
    ...
    """
    Receive event-based parameter data (Point machine/ELB current sampled every 20ms). Supports partial success.
    """
